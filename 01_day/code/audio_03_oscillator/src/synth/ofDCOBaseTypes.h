...
public:
    ...
    ofDCOSine();
    ofDCOSine(const float& freq);
    ofDCOSine(const float& freq, const float& amp, const float& phs);
    ~ofDCOSine(){};
...
public:
    ...
    ofDCOTriangle();
    ofDCOTriangle(const float& freq);
    ofDCOTriangle(const float& freq, const float& amp, const float& phs);
    ~ofDCOTriangle(){};
...
public:
    ...
    ofDCOSawTooth();
    ofDCOSawTooth(const float& freq);
    ofDCOSawTooth(const float& freq, const float& amp, const float& phs);
    ~ofDCOSawTooth(){};
...
public:
    ...
    ofDCOPulse();
    ofDCOPulse(const float& freq);
    ofDCOPulse(const float& freq, const float& amp, const float& phs);
    ~ofDCOPulse(){};
